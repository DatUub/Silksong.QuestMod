...
namespace QuestMod
{
    // Tag editor. Writes to QuestRequirements.user.json on every change.
    public partial class QuestGUI
    {
        ...
        // Hash tag -> hue. Same tag renders the same color so eyes can group it.
        ...
        private void DrawTagsTab()
        {
            ...
            GUILayout.Label("Tags drive bulk presets and conditions. Edits persist to QuestRequirements.user.json.");

            // Permanent overlay wipe. Per-session revert is the close-without-Save path.
            DrawTagsResetRow();
        ...
        private void DrawQuestTagRow(string quest, List<string> allTags)
        {
            ...
            foreach (var tag in allTags)
            {
                ...
                // Dim suggestions so active pills above stand out.
        ...
        private const float TagsResetArmWindow = QuestModConstants.ConfirmArmWindow;
