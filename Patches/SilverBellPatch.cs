...
namespace QuestMod
{
    public static class SilverBellPatch
    {
        ...
        private static void OnSceneLoaded(Scene scene, LoadSceneMode mode)
        {
            ...
            QuestModPlugin.Instance.InvokeAfterSeconds(() => PatchDroppers(queuedScene), 0.5f);
            QuestModPlugin.Instance.InvokeAfterSeconds(() => PatchDroppers(queuedScene), 2f);
        }

        private static void PatchDroppers(string queuedScene)
        {
